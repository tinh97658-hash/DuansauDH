...
export default function Workspace({ mode }) {
  ...
  return <FeatureLayout hideHeader workspaceMode={mode !== "matrix"}><div className={`scheduling-v20 v20-workspace ${mode === "create" ? "v20-create-workspace" : mode === "schedule" ? "v20-schedule-workspace" : mode === "matrix" ? "v20-matrix-workspace" : ""}`}>
